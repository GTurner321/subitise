9: {
            strokes: [{
                ...
                coordinates: [
                    // Complete the circle part first
                    ...
                    // Now go straight down from the circle
        ...
        9: {
            strokes: [{
                ...
                coordinates: [
                    ...
                    { x: 75, y: 109 }, { x: 80, y: 114 }, { x: 85, y: 119 }, { x: 90, y: 128 }, 
                    { x: 92, y: 133 }, { x: 94, y: 140 }, { x: 95, y: 150 }, 
                    { x: 95, y: 160 }, { x: 95, y: 170 }, { x: 95, y: 180 }, { x: 95, y: 190 }, 
                    { x: 90, y: 170 }, { x: 85, y: 150 }, { x: 80, y: 130 }, { x: 75, y: 110 }, 
                    { x: 70, y: 90 }, { x: 65, y: 70 }, { x: 60, y: 50 }, { x: 55, y: 30 }, 
                    { x: 50, y: 20 }, { x: 45, y: 10 }, { x: 40, y: 5 }, { x: 35, y: 2 }, 
                    { x: 30, y: 1 }, { x: 25, y: 0 }
                ],
                description: 'Draw 9 with more points along straight sections',
                type: 'coordinates'
            }]
        }
    },
