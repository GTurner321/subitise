...
const DRAW_CONFIG = {
    ...
    COMPLETION_POINTS: {
        ...
        9: [
        // CIRCULAR PART: Top loop (18 points - 67% of total)
        ...
        { x: 96, y: 158 }, { x: 98, y: 174 },
    
        // DESCENDING LINE: Straight line down (9 points - 33% of total)
        { x: 99, y: 182 }, { x: 97, y: 159 }, { x: 94, y: 137 }, { x: 92, y: 114 },
        { x: 90, y: 91 }, { x: 87, y: 68 }, { x: 85, y: 46 }, { x: 82, y: 23 }, { x: 80, y: 0 }
        ]
    },
